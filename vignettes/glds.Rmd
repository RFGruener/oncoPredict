...
cm<-read.table(vignette_file("complete_matrix_output_GDSCv2.txt"), header=TRUE, row.names=1) #Now, there are no NA values.
...
markerMat<-as.matrix(read.table(vignette_file("markerMat.txt"), header=TRUE, row.names=1))
